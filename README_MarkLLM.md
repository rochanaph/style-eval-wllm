> **Note.** This is the upstream README of the MarkLLM toolkit, which this repository is
> forked from. For the code and instructions of the paper "Evaluating LLM Watermarking for
> Clinical EHR: Detectability, Style Shifts, and Helpfulness" (EMNLP 2026 Main Conference),
